			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>E-Valuate</a></h1>
					</div>
					<!-- navigation -->
				...
				<div class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							...
							<div class="slider-info">
								<h3>Smart Assignment Tracking. Seamless Evaluation</h3>
								<p>Successful career starts with good practice</p>
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-check-square-o" aria-hidden="true"></span>E-Valuate</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p>&copy; E-valuate Online College Assignment System | </p>
		</div>
	</div>
	<!-- //Footer -->
